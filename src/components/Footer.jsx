          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              <a className="group relative hover:text-white transition-colors duration-300">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-72 bg-gray-800 border border-gray-700 rounded-xl p-4 text-gray-300 text-xs leading-relaxed invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-300 z-50 shadow-xl pointer-events-none">
                  <p className="font-semibold text-white mb-1">Privacy Policy</p>
                  <p>We are committed to protecting your personal information. We collect only what's necessary to provide our services, never sell your data to third parties, and give you full control over your information at any time.</p>
              ...
              <a className="group relative hover:text-white transition-colors duration-300">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-72 bg-gray-800 border border-gray-700 rounded-xl p-4 text-gray-300 text-xs leading-relaxed invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-300 z-50 shadow-xl pointer-events-none">
                  ...
                  <p>By using JobPortal, you agree to our terms governing your access and use of the platform, including job postings, applications, and employer interactions. Please read these terms carefully before using our services.</p>
                  <div className="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-gray-700"></div>
                </div>
              </a>
              <a className="group relative hover:text-white transition-colors duration-300">
                ...
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-72 bg-gray-800 border border-gray-700 rounded-xl p-4 text-gray-300 text-xs leading-relaxed invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-300 z-50 shadow-xl pointer-events-none">
                  ...
                  <p>We use cookies to enhance your browsing experience, analyze site traffic, and personalize content. By continuing to use JobPortal, you consent to our use of cookies in accordance with this policy.</p>
                  <div className="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-gray-700"></div>
                </div>
              </a>
              <Link
